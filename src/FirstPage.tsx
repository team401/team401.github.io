            ...
            <Grid xs={12}>
              <Paper sx={{ p: 3, minHeight: "100%" }}>
                ...
                >
                  ...
                  Technology) was founded by Dean Kamen in 1982. The{" "}
                  <i>FIRST</i> vision is "to transform our culture by creating a
                  world where science and technology are celebrated and where
                  young people dream of becoming science and technology
                  leaders." Today, thousands of <i>FIRST</i> competitions are
                  held all over the world for children of all age groups and
                  backgrounds.
                </Typography>
                <Typography
                  variant="body1"
