        ...
        <Grid xs={12}>
          <Card sx={{ mb: 4, p: 2, mx: 0 }}>
            ...
            >
              ...
              science and technology are celebrated and where young people dream
              of becoming science and technology leaders." Today, thousands of{" "}
              <i>FIRST</i> competitions are held all over the world for children
            ...
            <Typography
              ...
              paddingTop={2}
            >
              If you're interested in finding an existing team or starting a new
              team, we're happy to help, please{" "}
